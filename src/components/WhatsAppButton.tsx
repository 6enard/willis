...
const WhatsAppButton = () => {
  const phoneNumber = "254758000010";
  const message = "Hello! I'm interested in booking a room at The Willis Hotel. Could you please help me with availability and rates?";
